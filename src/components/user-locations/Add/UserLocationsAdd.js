...
function UserLocationsAdd() {
  ...
  const handleSubmit = (event) => {
    ...
    console.log("UserLocationsData", payload);

    try {
      // Call the Request component to handle the form submission
      PostRequest(UserLocationsData, '/UserLocations/Add/');
  ...
  return (
    <div className={style.mainDiv}>
      <PageHeader value="UserLocations Add" />
      <div className={style.pageContent}>

        <form onSubmit={handleSubmit}>
          
          <InputText label="Auth User" placeholder="" name="authUser" />
          <InputText label="Latitude" placeholder="" name="latitude" />
          <InputText label="Longitude" placeholder="" name="longitude" />
...
export default UserLocationsAdd;