...
import style from './ScheduleAdd.module.css'
...
function ScheduleAdd() {
  ...
  const handleSubmit = (event) => {
    ...
    console.log("ScheduleData", payload);

    try {
      // Call the Request component to handle the form submission
      PostRequest(ScheduleData, '/Schedule/Add/');
  ...
  return (
    <div className={style.mainDiv}>
      <PageHeader value="Schedule Add" />
      <div className={style.pageContent}>

        <form onSubmit={handleSubmit}>
          
          <InputText label="Header" placeholder="" name="header" />
          <InputText label="Description" placeholder="" name="description" />
          <InputText label="Number" placeholder="" name="number" />
          <InputText label="Footer" placeholder="" name="dooter" />
