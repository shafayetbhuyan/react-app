...
import style from './KhanaList.module.css'
...
export default function KhanaList() {
...
*/
    ...
    const khanaSearchParams = {"search.khanaNo.like":"", "pageNumber" : 1, "pageSize": 500,};

    return (
        <>
            <PageHeader value='Khana List' />
            ...
            <form className={style.searchForm} onSubmit={submitForm}>
                ...
                */}npm
                ...
                <SearchInputSelect name='search.khanaNo.like' label='Khana No' dataUrl='http://localhost:8960/api/masterData/Khana/List/' optionLabel='khanaNo' optionValue='id' searchParams={khanaSearchParams} />
